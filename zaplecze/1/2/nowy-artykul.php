<?php
	...
	if(isset($_POST["tresc"]))
	{
		...
		if ($polaczenie->query("INSERT INTO wpisy VALUES (NULL, '$tytul', '$tresc', 1, '$kategoria', NULL)"))
		{	
			echo 'Sukces.';
		} else {
			echo 'Wystąpił błąd!';
...
<head>
	...
	<title>Zarządzaj stroną - nowy artykuł</title>
		...
		<section id="right">	<!-- NARZĘDZIE --> <!-- NOWY ARTYKUŁ -->
			...
			<div id="editor">
				...
				<form enctype="multipart/form-data" method="post" action="">
					...
					<textarea name="tresc" id="mytextarea" ></textarea><br />
					...
					<a href="nowa-kategoria.php" target="_BLANK" class="link-colored">utwórz nową kategorie</a><br><br>
